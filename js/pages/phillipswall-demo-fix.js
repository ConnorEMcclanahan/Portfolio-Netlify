...
(function () {
  ...
  function renderCard(dir) {
    ...
    var h = '<div class="expanded-card" style="background:#BFE3FF">' +
      '<button class="expanded-card__close" aria-label="Close"><svg viewBox="0 0 16 16" width="14" height="14" aria-hidden="true"><path d="M3 3 L13 13 M13 3 L3 13" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" /></svg></button>' +
